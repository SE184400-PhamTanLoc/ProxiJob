...
export default function UpgradePackageScreen() {
  const { navigateTo, goBack, showToast } = useContext(AppContext);
  ...
  return (
    <SafeAreaView style={s.container}>
      <View style={s.header}>
        ...
        <Text style={s.logo}>ProxiJob</Text>
        <View style={{ width: 40 }} />
      </View>
            ...
            <>
              ...
              {basic && (
                <View style={s.card}>
                  ...
                  <PurchaseBtn plan={basic} loading={loading} onPress={handlePurchase} label="Nâng cấp ngay" color="#FF6B00" />
                </View>
              )}
              ...
              {standard && (
                <View style={[s.card, s.cardPro]}>
                  ...
                  <PurchaseBtn plan={standard} loading={loading} onPress={handlePurchase} label="Nâng cấp ngay" color="#FF6B00" />
                </View>
              )}
              ...
              {premium && (
                <View style={[s.card, s.cardPremium]}>
                  ...
                  <PurchaseBtn plan={premium} loading={loading} onPress={handlePurchase} label="Nâng cấp ngay" color="#7C3AED" />
                </View>
              )}
...
function PurchaseBtn({ plan, loading, onPress, label, color, outline }) {
...
const s = StyleSheet.create({
  ...
  backArrow: { fontSize: 22, color: '#1F2937', fontWeight: 'bold' },
  logo: { fontSize: 20, fontWeight: '800', color: '#FF6B00' },
